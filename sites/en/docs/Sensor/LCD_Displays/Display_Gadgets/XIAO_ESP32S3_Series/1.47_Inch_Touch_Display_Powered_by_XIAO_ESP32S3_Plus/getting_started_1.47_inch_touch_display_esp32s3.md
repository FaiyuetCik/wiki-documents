...
<!-- TODO: Add screenshot/GIF of the Hello output (147_ESP32S3Plus_display_hello.png) -->
<!-- <div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_display_hello.png" style={{width:500, height:'auto'}}/></div> -->
...
The display board packs several onboard peripherals. The [Function](/function_1.47_inch_touch_display_esp32s3) page provides a standalone demo for each one:
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>Microphone</td><td>[Big Volume Bar](/function_1.47_inch_touch_display_esp32s3#microphone--big-volume-bar) — live PDM level meter</td></tr>
