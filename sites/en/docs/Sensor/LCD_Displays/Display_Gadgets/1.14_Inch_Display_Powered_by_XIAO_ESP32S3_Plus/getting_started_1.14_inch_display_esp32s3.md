...
<div class="github_container" style={{textAlign: 'center'}}>
    <a class="github_item" href="https://github.com/Seeed-Projects/Display-Gadgets/tree/main/code/example/114_ESP32/0703_DashBoard_114_ESP32" target="_blank" rel="noopener noreferrer">
...
Navigate to `code/example/114_ESP32/0703_DashBoard_114_ESP32/` and open `0703_DashBoard_114_ESP32.ino` in Arduino IDE.
