---
description: Getting Started with 1.47 Inch Touch Display Powered by XIAO nRF52840 Plus.
title: Getting Started with 1.47 Inch Touch Display Powered by XIAO nRF52840 Plus
keywords:
  - XIAO
  - nRF52840
  - Touch Display
...
# Getting Started with 1.47 Inch Touch Display Powered by XIAO nRF52840 Plus

<div class="table-center">
  <table align="center">
    <tr><th>1.47 Inch Touch Display (XIAO nRF52840 Plus)</th></tr>
    <tr><td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_display_hardware_hero.jpg" style={{width:600, height:'auto'}}/></div></td></tr>
...
The 1.47 Inch Touch Display is an expansion board designed for the XIAO series, powered by the XIAO nRF52840 Plus. It features a 172×320 color LCD with capacitive touch, onboard PDM microphone, 6-axis IMU (LSM6DS3), MicroSD card slot, and battery power management — all integrated into a compact form factor.
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>Buttons</td><td>BTN_B = D15 / BTN_A = D19 (2 buttons, active-low)</td></tr>
    <tr><td>Battery</td><td>LiPo battery connector, voltage measurement with percentage display</td></tr>
    <tr><td>Expansion</td><td>I2C breakout (GND, 3V3, SDA, SCL); Button breakout (U1, U2); I2S breakout (3V3, GND, D11, D12, D13); SWD (DIO, CLK, RST, GND)</td></tr>
...
The 1.47 Inch Touch Display breaks out all XIAO nRF52840 Plus pins. The table below lists every pin, its net name on the display board, its function, and how it is connected to onboard peripherals.
...
<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_uploadpage.png" style={{width:1000, height:'auto'}}/></div>
...
At the top of the screen, **"Hello,XIAO!"** is displayed in large green text, with a subtitle reading **"1.47 Inch Touch Display"** in cyan below it. This static banner appears on boot — if you see it without artifacts or tearing, the LCD is working correctly.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_welcome_banner.gif" style={{width:500, height:'auto'}}/></div>

**SD Card Status**

The **SYSTEM** card shows **"SD"** followed by the card status. Insert a MicroSD card and the text changes from **"Unplugged"** (red) to **"OK"** (green). Remove the card and the status reverts. If the card is not detected, check that it is formatted as FAT32.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_sd_card.gif" style={{width:500, height:'auto'}}/></div>

**Touch Coordinates**

Below the SD status, **"Touch"** prints real-time coordinate data. When the screen is untouched it reads **"release"**. Place a finger on the screen and the display updates to **"(X, Y)"** — the absolute pixel position of your touch point. Slide your finger around to see the coordinates update.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_touch_sliding.gif" style={{width:500, height:'auto'}}/></div>

**Battery**

The **"BAT"** line shows a battery icon, percentage, and a charging indicator. There are three scenarios:

- **USB-C powered, no battery** — displays a crossed-out battery icon with **"USB PWR"** in red.
...
<div class="table-center">
  <table align="center">
    <tr>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_battery_states1.jpg" style={{width:220, height:'auto'}}/></div></td>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_battery_states2.jpg" style={{width:220, height:'auto'}}/></div></td>
    </tr>
    <tr>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_battery_states3.jpg" style={{width:220, height:'auto'}}/></div></td>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_battery_states4.jpg" style={{width:220, height:'auto'}}/></div></td>
    </tr>
  </table>
</div>
...
<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_motion.gif" style={{width:500, height:'auto'}}/></div>
...
<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_touch.gif" style={{width:500, height:'auto'}}/></div>

**Microphone Level**

The **MIC LEVEL** card displays a VU-style audio meter — a segmented horizontal bar that grows and shrinks with the ambient sound volume. In a quiet room the bar stays empty or nearly so. Speak into the onboard PDM microphone or blow on it, and the bar fills up, turning orange at high volume levels. The raw peak value is printed below the bar for debugging.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_mic.gif" style={{width:500, height:'auto'}}/></div>
...
<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_nRF52840Plus_touch_display_dashboard_button.gif" style={{width:500, height:'auto'}}/></div>
...
- **[GitHub]** [XIAO Display Board Demo Code](https://github.com/Seeed-Projects/Display-Gadgets)
