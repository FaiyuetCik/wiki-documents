...
<!-- TODO: Add front view image (147_ESP32S3Plus_display_hardware_front.jpg) -->
<!-- <div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_hardware_front.jpg" style={{width:600, height:'auto'}}/></div> -->

### Back View

<!-- TODO: Add back view image (147_ESP32S3Plus_display_hardware_back.jpg) -->
<!-- <div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_hardware_back.jpg" style={{width:600, height:'auto'}}/></div> -->
...
<div class="table-center">
  <table align="center">
    ...
    <tr><td>D14</td><td>IMU_INT</td><td>IMU motion interrupt</td><td>Function reassignment: used for motion wake-up and double-tap detection</td></tr>
...
<!-- TODO: Add annotated pinout image (147_ESP32S3Plus_display_pinout.png) -->
<!-- <div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_pinout.png" style={{width:1000, height:'auto'}}/></div> -->

## Getting Started — Dashboard

The product ships with a **Factory Dashboard** firmware preloaded, which demonstrates all onboard peripherals: screen display, touch input, IMU data, microphone, SD card, battery voltage, button-controlled backlight, and double-tap detection. The steps below walk you through setting up the development environment and re-flashing this firmware — useful if you want to restore the factory demo after experimenting with your own code, or use it as a starting point for your own projects.
...
- **Touch Driver Library (Manual Installation)** — the **esp_lcd_touch_axs5106l** touch driver must be installed manually:

<div class="github_container" style={{textAlign: 'center'}}>
    <a class="github_item" href="https://github.com/Seeed-Projects/Display-Gadgets/tree/main/code/example/147_ESP32/0703_DashBoard_147_ESP32/esp_lcd_touch_axs5106l" target="_blank" rel="noopener noreferrer">
...
**Step 1.** Clone the [Display-Gadgets](https://github.com/Seeed-Projects/Display-Gadgets) repository (or download the whole repo as a ZIP), then copy the `code/example/147_ESP32/0703_DashBoard_147_ESP32/esp_lcd_touch_axs5106l/` folder into your Arduino libraries folder. GitHub does not provide a per-folder "Download ZIP" button.
...
:::note
**GFX Library for Arduino** above is required for the factory Dashboard firmware. The [Function](/function_1.47_inch_touch_display_esp32s3) demos instead use **Seeed_GFX2** (installed manually as described on that page) — the two graphics libraries serve different purposes and are not interchangeable, so install whichever the specific tutorial asks for.
:::
...
<div class="github_container" style={{textAlign: 'center'}}>
    <a class="github_item" href="https://github.com/Seeed-Projects/Display-Gadgets/tree/main/code/example/147_ESP32/0703_DashBoard_147_ESP32" target="_blank" rel="noopener noreferrer">
    <strong><span><font color={'FFFFFF'} size={"4"}> Download the Code</font></span></strong>
    <svg aria-hidden="true" focusable="false" role="img" className="mr-2" viewBox="-3 10 9 1" width={16} height={16} fill="currentColor" style={{textAlign: 'center', display: 'inline-block', userSelect: 'none', verticalAlign: 'text-bottom', overflow: 'visible'}}><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z" /></svg>
    </a>
</div><br />

Navigate to `code/example/147_ESP32/0703_DashBoard_147_ESP32/` and open `0703_DashBoard_147_ESP32.ino` in Arduino IDE.
...
At the top of the screen, **"Hello,XIAO!"** is displayed in large green text, with a subtitle reading **"1.47 Inch Touch Display"** in cyan below it, followed by a horizontal separator line. This static banner appears on boot — if you see it without artifacts or tearing, the LCD is working correctly.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_dashboard_welcome_banner.gif" style={{width:500, height:'auto'}}/></div>

**SD Card Status**

The **SYSTEM** card shows **"SD"** followed by the card status. Insert a MicroSD card and the text changes from **"Unplugged"** (red) to **"OK 400k"** (green) showing the SPI frequency. Remove the card and the status reverts. If the card is not detected, check that it is formatted as FAT32.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_dashboard_sd_card.gif" style={{width:500, height:'auto'}}/></div>

**Touch Coordinates**

Below the SD status, **"Touch"** prints real-time coordinate data. When the screen is untouched it reads **"release"**. Place a finger on the screen and the display updates to **"(X, Y)"** — the absolute pixel position of your touch point. Slide your finger around to see the coordinates update. The touch controller reports up to 350ms holdover after release to prevent flickering.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_dashboard_touch_sliding.gif" style={{width:500, height:'auto'}}/></div>

<a id="battery-voltage"></a>

**Battery Voltage**

The **SYSTEM** card displays two voltage readings: **D16** (raw ADC voltage at the pin) and **Calc** (calculated battery voltage, multiplied by the divider ratio of ~2.975). The voltage divider circuit is: `VBAT → 316K → ADC node → 160K → GND`.
...
<div class="table-center">
  <table align="center">
    <tr>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_battery_states1.jpg" style={{width:220, height:'auto'}}/></div></td>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_battery_states2.jpg" style={{width:220, height:'auto'}}/></div></td>
    </tr>
    <tr>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_battery_states3.jpg" style={{width:220, height:'auto'}}/></div></td>
      <td><div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_battery_states4.jpg" style={{width:220, height:'auto'}}/></div></td>
    </tr>
  </table>
</div>
...
<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_dashboard_double_tap.gif" style={{width:500, height:'auto'}}/></div>

**Microphone Level**

The **MIC LEVEL** card displays a VU-style audio meter — a segmented horizontal bar that grows and shrinks with the ambient sound volume. In a quiet room the bar stays empty or nearly so. Speak into the onboard PDM microphone or blow on it, and the bar fills up from left to right:

- Segments 1–7: **Green**
- Segments 8–12: **Orange**

The raw peak value is printed below the bar for debugging. The VU meter uses a fast-attack / slow-release smoothing to match natural audio perception.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_dashboard_mic.gif" style={{width:500, height:'auto'}}/></div>

**Button & Backlight Control**

The **BACKLIGHT / BUTTON** card at the bottom shows the current brightness percentage and the two push-button mappings:

<div class="table-center">
  <table align="center">
    <tr><th>Button</th><th>Pin</th><th>Action</th></tr>
    <tr><td><strong>USR1</strong></td><td>D19</td><td>Short press: cycle brightness through <strong>100% → 75% → 50% → 25% → 0% → 100%</strong></td></tr>
    <tr><td><strong>USR2</strong></td><td>D15</td><td>Short press: <strong>toggle screen off / restore to last brightness</strong></td></tr>
  </table>
</div>

When the screen is off (0% or toggled), pressing USR2 restores it to the previous non-zero level.

<div style={{textAlign:'center'}}><img src="https://files.seeedstudio.com/wiki/Display_Gadgets/imgs/147_ESP32S3Plus_touch_display_dashboard_button.gif" style={{width:500, height:'auto'}}/></div>
