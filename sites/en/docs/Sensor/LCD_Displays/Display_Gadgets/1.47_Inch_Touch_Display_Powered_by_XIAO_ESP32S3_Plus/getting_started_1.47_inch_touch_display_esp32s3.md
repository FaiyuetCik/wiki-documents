...
**Step 1.** Click the button above to download the `esp_lcd_touch_axs5106l` library folder as a ZIP file. Alternatively, you can clone the repository and copy the `code/example/147_ESP32/0703_DashBoard_147_ESP32/esp_lcd_touch_axs5106l/` folder directly.
